...
def main() -> None:
    ...
    g_time.add_argument(
        "--stfx",
        action="append",
        help="Add a subtitle visual effect. Format: NAME:CHANCE:STRENGTH (e.g., fadein:50:1..3). Available: fadein, fadeout, slidein, slideout, blur, flickering, jumping, moving, tilt, opacity, none, onlyvtt",
    )
    g_time.add_argument(
        "--stfx-chance",
        dest="stfx_chance",

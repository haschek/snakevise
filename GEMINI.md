...
- **Language**: Python 3.8+
- **Core Libraries**:
  - `opencv-python` (cv2): Image and video processing. (Deprecated in favor of moviepy/PIL but listed for reference)
...
- All Markdown files must follow standard `markdownlint` rules (e.g., no trailing spaces, proper header nesting, single top-level header).
